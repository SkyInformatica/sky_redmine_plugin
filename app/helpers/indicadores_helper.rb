      ...
      safe_join([
        render_cards_row([
          render_card_valor(
            ...
            "RT: #{dados_graficos_etapas[:tarefas_devel_rt_total]} (#{format("%.1f%%", (dados_graficos_etapas[:tarefas_devel_rt_total]).to_f / dados_graficos_etapas[:tarefas_devel_total] * 100)})"
          ),
          render_card_valor(
            ...
            "RT: #{dados_graficos_etapas[:tarefas_devel_por_etapa]["E02_EM_ANDAMENTO_DEVEL_RT"]} (#{format("%.1f%%", (dados_graficos_etapas[:tarefas_devel_por_etapa]["E02_EM_ANDAMENTO_DEVEL_RT"]).to_f / dados_graficos_etapas[:tarefas_devel_total] * 100)})",
            nil,
          ...
          render_card_valor(
            ...
            "RT: #{dados_graficos_etapas[:tarefas_devel_por_etapa]["E06_EM_ANDAMENTO_QS_RT"]} (#{format("%.1f%%", (dados_graficos_etapas[:tarefas_devel_por_etapa]["E06_EM_ANDAMENTO_QS_RT"]).to_f / dados_graficos_etapas[:tarefas_devel_total] * 100)})",
            nil,
