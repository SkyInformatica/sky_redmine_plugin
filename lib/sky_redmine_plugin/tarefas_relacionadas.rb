  ...
  module TarefasRelacionadas
    def self.obter_lista_tarefas_relacionadas(tarefa)
      ...
      tarefas.map do |tarefa|
        ...
        tarefa.instance_variable_set(:@data_atendimento, data_atendimento&.to_datetime)
        tarefa.instance_variable_set(:@data_criacao, data_criacao&.to_datetime)
        tarefa.instance_variable_set(:@data_em_andamento, data_em_andamento&.to_datetime)
        tarefa.instance_variable_set(:@data_resolvida, data_resolvida&.to_datetime)
        tarefa.instance_variable_set(:@data_fechada, data_fechada&.to_datetime)
