namespace :sky_redmine_plugin do
  desc "Atualiza o campo situacao_atual em todos os registros de SkyRedmineIndicadores"
  task update_situacao_atual: :environment do
    puts "Iniciando atualização do campo situacao_atual para todos os indicadores..."
